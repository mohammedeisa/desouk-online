...
class FrontController extends Controller
{
    ...
    /**
     * @Route("/mall_categories_menu" , name ="mall_categories_menu")
     * @Template("DesoukOnlineMallBundle:Front:Mall/mall_categories_menu.html.twig")
     */
    public function mallCategoriesMenuAction()
    {
        $categories = $this->getDoctrine()->getManager()->getRepository(get_class(new Category()))->findAll();
        return array('_categories' => $categories);
    }
